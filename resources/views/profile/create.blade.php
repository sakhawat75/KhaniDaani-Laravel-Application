  ...
  <section class="dashboard-area">
    ...
    <div class="dashboard_contents">
      <div class="container">
        ...
        <form action="{{ route('home') }}/profile" class="setting_form" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
                ...
                <div class="information__set toggle_module collapse show" id="collapse2">
                  <div class="information_wrapper form--fields">
                    <div class="form-group">
                      ...
                      <input type="text" id="acname" class="text_field" name="fullname">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" id="mobile" class="text_field" name="dob">
                    </div>

                    <div class="form-group">
                      <label for="mobile2">Phone No</label>
                      <input type="text" id="mobile2" class="text_field" name="mobile_no">
                    </div>
...
--}}
                    <div class="form-group">
                      ...
                      <textarea name="description" id="article-ckeditor" class="text_field"></textarea>
                    </div>
                  </div>
                ...
                <div class="information__set profile_images toggle_module collapse" id="collapse3">
                  <div class="information_wrapper">
                    <div class="profile_image_area">
                      <img src="images/authplc.png" alt="Author profile area" id="preview_profile_image"
