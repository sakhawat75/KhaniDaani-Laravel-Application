	...
	<section class="dashboard-area">
	    ...
	    <div class="dashboard_contents">
	        <div class="container">
	            ...
	            <form action="{{ route('profile.update', ['profile' => $profile->id])  }}" class="setting_form" method="post" enctype="multipart/form-data">
					@csrf
	            	@method('PUT')
	                            ...
	                            <div class="information__set profile_images toggle_module collapse" id="collapse3">
	                                <div class="information_wrapper">
	                                    <div class="profile_image_area">
	                                        <img src="{{ route('home') }}/images/authplc.png" alt="Author profile area" id="preview_profile_image" style="height: 100px;width: 100px;">
	                                        <div class="img_info">
	                                    ...
	                                    <div class="prof_img_upload">
	                                        ...
	                                        <img src="{{ route('home') }}/images/cvrplc.jpg" alt="The great warrior of China" id="preview_cover">
